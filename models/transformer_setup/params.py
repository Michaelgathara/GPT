class ModelConfig:
    def __init__(self):
        ...
        self.n_head = 16  # Number of attention heads (1536 / 12 = 128 head dim)
        ...
        # MLA Parameters
        self.n_latent_vec = 64  # Number of global latent vectors
        self.latent_dim = (
            self.n_embd
        )  # Dimension of each latent vector (can be n_embd or different)
        self.use_mla_in_blocks = [
            0,
            2,
            5,
        ]  # List of block indices where MLA should be applied
        # Alternatively, an interval: mla_every_n_layers = 3
        self.mla_dropout_prob = 0.1  # Dropout for MLA components
